...
int main(int argc, char* argv[]) {
	...
	//Grid Search works really well! Tie breaking implemented, too!
	//OctileDistance h;
	...
	//goal.c.x = 60;
	//goal.c.y = 0;
	//InefficientAstar<Node<Coordinate>, Action, OctileGrid, OctileDistance> gridSearch;
	//if (gridSearch.getPath(grid, start, goal, h))
	//{
